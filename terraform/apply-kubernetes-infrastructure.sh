...
echo; echo "## Terraform: applying Kubernetes infrastructure"
(
    set -ex
    terraform apply -auto-approve
)

terraform output -raw control_plane_ip > /secrets/control_plane_ip
terraform output -raw worker_1_ip > /secrets/worker_1_ip
terraform output -raw worker_2_ip > /secrets/worker_2_ip
